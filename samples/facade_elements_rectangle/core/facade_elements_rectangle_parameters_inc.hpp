#ifndef FACADE_ELEMENTS_RECTANGLE_PARAMETERS_INC_HPP
#define FACADE_ELEMENTS_RECTANGLE_PARAMETERS_INC_HPP
...
void initialize_parameters(T* params)
{
    ...
    params->template insert<bool>("test",'b',true, "test");
    ...
    params->template insert<double>("ponderation_gradient",'\0',1, "Ponderation de l'energie de gradient");
...
#endif // FACADE_ELEMENTS_RECTANGLE_PARAMETERS_INC_HPP
