...
template void image_gradient_unary_energy::gradient<rjmcmc::any_const_view_t>(const rjmcmc::any_const_view_t& view, const Iso_Rectangle_2& bbox, double sigmaD, unsigned int step);

#include "core/gradient_image_inc.hpp"
template void rjmcmc::gradient_image::load<rjmcmc::any_const_view_t>(const rjmcmc::any_const_view_t& view, const Iso_Rectangle_2& bbox, double sigmaD, unsigned int step);
